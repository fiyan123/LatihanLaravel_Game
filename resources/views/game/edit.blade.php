                        ...
                        <form action="{{ route('game.update', $game->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control  @error('nama_game') is-invalid @enderror"
                                    name="nama_game" value="{{ $game->nama_game }}">
                                @error('nama_game')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control  @error('nama_pembuat') is-invalid @enderror"
                                    name="nama_pembuat" value="{{ $game->nama_pembuat }}">
                                @error('nama_pembuat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control  @error('tahun_dirilis') is-invalid @enderror"
                                    name="tahun_dirilis" value="{{ $game->tahun_dirilis }}">
                                @error('tahun_dirilis')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ route('game.index') }}" class="btn btn-primary">Kembali</a>
                                </div>
                            </div>
                        </form>
                    </div>
